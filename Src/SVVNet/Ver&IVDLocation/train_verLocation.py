...
from DataLoader.dataloader_Verlocation import get_loader
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='../../../Output/Ver_Location/latest.pkl')
    ...
    trainer.setting.project_name = 'Ver_Location'
