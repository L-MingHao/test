...
def random_shift(list_images, p=0.25):
    shift_factor = random.uniform(-p, p)
    intensity_value = random.uniform(0.75, 1.25)
    for img_i in range(len(list_images)):
        list_images[img_i] = list_images[img_i] * intensity_value + shift_factor
